  ...
  return (
    <div className="mx-auto max-w-screen-lg mt-4 py-5 px-10">
      ...
      <p className="text-lg text-white leading-8">
        Welcome to <span className="font-bold">WeatherTapp!</span> We are a team of dedicated developers focused on providing accurate and up-to-date weather information. Our mission is to make it easier for you to plan your day, no matter where you are. With detailed forecasts, weather alerts, and a user-friendly interface, we aim to be your go-to source for reliable weather updates.
      </p>
